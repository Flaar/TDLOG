...
public class PartageRDV extends Activity {
	  ...
	  public void onCreate(Bundle savedInstanceState) {
	    ...
	    mOptions = new String[]{"Vassily", "Benjamin", "Hugues", "Robin", "Quentin", "Quelq'un", "..."};
	    ...
	    mOK.setOnClickListener(new View.OnClickListener() {
	      ...
	      public void onClick(View v) {
	        Toast.makeText(PartageRDV.this, "Merci ! Les données ont été envoyées !", Toast.LENGTH_LONG).show();
	        ...
	        mListOpt.setAdapter(new ArrayAdapter<String>(PartageRDV.this, android.R.layout.simple_list_item_1, mOptions));
