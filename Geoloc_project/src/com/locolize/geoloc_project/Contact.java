...
public class Contact extends LPOI{
	...
	public Contact(String new_name, String new_surname, String new_phone_number){
	...
	public Contact(int new_id,String new_name, String new_surname, String new_phone_number){
		phone_number=new_phone_number;
		id=new_id;
		name=new_name;
		surname=new_surname;
	...
	public void setNumber(String num){this.phone_number=num;}
	...
	public String getNum(){return this.phone_number;}
